...
// Pinecrest Stories - social / BTS workspace. Posts seeded here so that
// switching workspaces also lands the user on a feed with enough posts to
// trigger the lazy-load second page (page size 6).
const acmeSocialPostInputs: SeedPostInput[] = [
  {
    id: 'post_social_live_1',
    status: 'live',
    title: 'Behind the scenes at the Marina open house',
    description: 'Setup, the rush, and a couple of unexpected questions.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 42,
    daysFromEpoch: 18,
    views: 24800,
    ctrPercent: 7,
  ...
  {
    id: 'post_social_live_2',
    status: 'live',
    title: 'Friday team retro in 60 seconds',
    description: 'What worked, what did not, what we are trying next week.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/team',
    durationSeconds: 58,
    daysFromEpoch: 16,
    views: 12200,
    ctrPercent: 5,
  ...
  {
    id: 'post_social_live_3',
    status: 'live',
    title: 'Coffee with a first-time buyer',
    description: 'Honest conversation about the months leading up to the offer.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 51,
    daysFromEpoch: 14,
    views: 18900,
    ctrPercent: 8,
    watchThroughRate: 0.74,
    avgWatchSeconds: 38,
  },
  {
    id: 'post_social_live_4',
    status: 'live',
    title: 'How we prep a listing in two hours',
    description: 'Photographer, stager, and one really good playlist.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/process',
    durationSeconds: 49,
    daysFromEpoch: 12,
    views: 9400,
    ctrPercent: 6,
    watchThroughRate: 0.69,
    avgWatchSeconds: 34,
  },
  {
    id: 'post_social_live_5',
    status: 'live',
    title: 'A quick hello from the new hire',
    description: 'Welcoming Anita to the Stories team.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 35,
    daysFromEpoch: 10,
    views: 6300,
    ctrPercent: 4,
    watchThroughRate: 0.62,
    avgWatchSeconds: 22,
  },
  {
    id: 'post_social_live_6',
    status: 'live',
    title: 'One thing every agent should screenshot today',
    description: 'A 30-second tip from the broker channel.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/tip',
    durationSeconds: 30,
    daysFromEpoch: 8,
    views: 15700,
    ctrPercent: 9,
    watchThroughRate: 0.78,
    avgWatchSeconds: 24,
  },
  {
    id: 'post_social_live_7',
    status: 'live',
    title: 'The before-and-after that surprised everyone',
    description: 'A staging swap that took the listing from quiet to four offers.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 47,
    daysFromEpoch: 7,
    views: 31200,
    ctrPercent: 10,
    watchThroughRate: 0.81,
    avgWatchSeconds: 38,
  },
  {
    id: 'post_social_approved_1',
    status: 'approved',
    title: 'Office tour - the new Stories desk',
    description: 'Quick walk through the recording corner we set up this month.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/office',
    durationSeconds: 40,
    daysFromEpoch: 6,
    views: 0,
    ctrPercent: 0,
  ...
  {
    id: 'post_social_approved_2',
    status: 'approved',
    title: 'Quote of the week from the Tuesday standup',
    description: 'Fifteen seconds that got the whole team laughing.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 18,
    daysFromEpoch: 5,
  ...
  {
    id: 'post_social_pending_1',
    status: 'pending',
    title: 'Day in the life - Saturday showings',
    description: 'Three properties, two offers, one really good lunch.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/saturday',
    durationSeconds: 60,
    daysFromEpoch: 4,
    views: 0,
    ctrPercent: 0,
  ...
  {
    id: 'post_social_pending_2',
    status: 'pending',
    title: 'Why we changed our intake form',
    description: 'Two minutes on a small change that saved hours per week.',
    tagIds: [],
    cta: acmeSocialCtas[0],
    durationSeconds: 55,
    daysFromEpoch: 3,
  ...
  {
    id: 'post_social_needs_edits_1',
    status: 'needs_edits',
    title: 'Naming the listing - a writers room',
    description: 'How the team picks listing titles that actually click.',
    tagIds: [],
    cta: acmeSocialCtas[1],
    ctaUrl: 'https://example.com/copy',
    durationSeconds: 53,
    daysFromEpoch: 2,
    views: 220,
    ctrPercent: 2,
    watchThroughRate: 0.45,
    avgWatchSeconds: 24,
    adminNote: 'Tighten the open by 8s; the workshop framing kicks in too late.',
  },
];
...
function buildInitialState(): SeedState {
  ...
  const postsByWorkspace: Record<string, Post[]> = {
    ...
    ws_social_acme: acmeSocialPostInputs.map((p) => buildPost('ws_social_acme', p)),
    ws_skills_globex: [],
    ws_partner_initech: [],
  };
