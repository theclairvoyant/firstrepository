...
// Build-time env var. Falls back to an IANA-reserved example.com address
// (no real brand) so dev builds show a working mailto link. The CTO sets
// the real address via EXPO_PUBLIC_SUPPORT_EMAIL before launch.
